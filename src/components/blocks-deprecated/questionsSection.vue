        ...
        <div class="container">
            <div class="questions__body">
                ...
                <div class="questions__row">
                    <div
                        class="questions__quest"
                        v-if="!isMobile || showQuestForMobile"
                    >
                        <questBlock
                    ...
                    <div
                        class="questions__right right-questions"
                        v-if="!showQuestForMobile"
                    >
                        <div class="right-questions__images images-questions">
                            <div class="images-questions__bg ibg">
                                <picture>
                                    <source
                                        ...
                                        srcset="../../assets/img/main/questions/f.png"
                                    />
                                    <source
                                        media="(max-width: 992px)"
                                        srcset="../../assets/img/main/questions/f-small.png"
                                    />
                                    <img
                                        src="../../assets/img/main/questions/f.png"
                                        alt="image"
                                    />
                                </picture>
                            </div>
                            <div class="images-questions__image">
                                <picture>
                                    <source
                                        media="(min-width: 991px)"
                                        srcset="../../assets/img/main/questions/b.png"
                                    />
                                    <source
                                        media="(max-width: 992px)"
                                        srcset="../../assets/img/main/questions/b-small.png"
                                    />
                                    <img
                                        src="../../assets/img/main/questions/b.png"
                                        alt="image"
                                    />
                                </picture>
                            </div>
                        ...
                        <p
                            class="right-questions__text"
                            v-if="!isMobile"
                        >
                            Ответьте на 5 вопросов и получите горку из шампанского вподарок
                        </p>
                        <div
                            class="right-questions__button"
                            v-else
                        >
                            <baseButton
                                tag="button"
            ...
            questions: [
                {
                    ...
                    currentPicked: "5-30",
                    variants: ["5-30", "30-60", "60-80", "80-100", "100-120"],
                },
                {
                ...
                },
                {
                    question: "Текст вопраса ",
                    currentPicked: "",
                    variants: ["Ответ 1", "Ответ 2", "Ответ 3", "Ответ 4", "Ответ 5"],
                },
                {
                    question: "Текст вопраса ",
                    currentPicked: "",
